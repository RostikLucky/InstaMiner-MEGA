...
0. [Установка на компьютер](#Установка-на-компьютер)
1. [Как обновить бота](#Как-обновить-бота)
2. [Как пользоваться ботом](#Как-пользоваться-ботом)
3. [Уведомления в Telegram](#Уведомления-в-Telegram)
4. [Автосмена аккаунтов Instagram](#Автосмена-аккаунтов-Instagram)
5. [Многопоток](#Многопоток)
6. [Дополнительные функции](#Дополнительные-функции)
7. [Ответы на часто задаваемые вопросы](#Ответы-на-часто-задаваемые-вопросы)
8. [Авторешение капчи](#Авторешение-капчи)
...
2. Нажмите "Удалить" и установите новую версию расширения, как было [описано выше](#Установка-на-компьютер)
...
1. Войдите в https://wiq.ru/ и в https://www.instagram.com/
2. Откройте расширение InstaMiner MEGA

![Откройте расширение InstaMiner MEGA](https://telegra.ph/file/2e2bc7e1bf0848b0fcf47.png "1рк")

3. Введите свой Telegram ID 
[Как узнать свой Telegram ID?](https://telegra.ph/Uvedomleniya-v-Telegram-03-25)

![](https://telegra.ph/file/8ba1d969c5be230de7b77.png "1рк")

4. Нажмите на кнопку "Проверить"
5. После загрузки, вы попадете в расширение
6. Откройте настройки и настройте бота под себя :)

![](https://telegra.ph/file/279beab367d3dfa4cac56.png "1рк")

![](https://telegra.ph/file/99f4ca9de90d501b8d30d.png "1рк")
...
Заработанные деньги будут начисляться на сайт Wiq.ru
Скорость работы бота зависит от **вашего интернета, вашего компьютера, работы сайта wiq.ru, количества заданий на сайте и ваших задержек.** Рекорд: 10 руб за 23 минуты


## Уведомления в Telegram
1. Для начала переходим в Telegram, в поиске находим бота @BotFather, заходим в беседу с ним и нажимаем Начать (/start)

![](https://leonardo.osnova.io/61b9bc0c-5149-b797-24eb-cd5a86a94ef7/-/preview/1400/-/format/webp/ "1рк")

2. Находясь в диалоге с @BotFather, отправляем ему команду /newbot или выбираем ее из списка команд, который он нам прислал

![](https://leonardo.osnova.io/107f7ccb-0214-8986-0db7-76d780670f0a/-/preview/1400/-/format/webp/ "1рк")

3. В ответ на сообщение вводим название нового бота

![](https://leonardo.osnova.io/24ca0e82-c9cf-acdc-e3ef-86618bb1acee/-/preview/1400/-/format/webp/ "1рк")

4. Придумываем уникальный юзернейм нового бота, важно чтобы он оканчивался на "bot" или "_bot" (пример: "hello_bot", "newbot", "best_bot", "iampuzzlebot" и тд.)

![](https://leonardo.osnova.io/f4b5462e-17eb-2447-698c-ac26e0f5c550/-/preview/1400/-/format/webp/ "1рк")

5. Копируем API ключ из Telegram клиента

![](https://leonardo.osnova.io/4323f632-f5ea-2985-dd40-b587fc4584be/-/preview/1400/-/format/webp/ "1рк")

### Данный API ключ вставляем в настройках бота - "Токен телеграм бота"

6. После этого вы можете включить уведомления и управление ботом через Телеграм


## Автосмена аккаунтов Instagram
1. Перейдите во вкладку **"Аккаунты"**
2. Нажмите на кнопку добавить аккаунт 

![](https://telegra.ph/file/903a20dfdda33e6ae8687.png "1рк")
...
* Иметь несколько аккаунтов в wiq.ru
* Иметь несколько прокси

1. Создайте нового пользователя в Google Chrome

![](https://telegra.ph/file/280fd78e049a06c205df7.png "1рк")

![](https://telegra.ph/file/086751a7661c5951d09f7.png "1рк")

2. Установите бота для нового пользователя также, как написано выше в инструкции. 

3. После этого войдите в Wiq.ru Запустите бота и введите в настройках свой прокси.
